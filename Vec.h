...
#define DEFINE_VEC(TYPE, NAME)                                                 \
	...
	static size_t vec_##NAME##_size(Vec_##NAME *self);                         \
	...
	static TYPE *vec_##NAME##_begin(Vec_##NAME *self);                         \
	static TYPE *vec_##NAME##_end(Vec_##NAME *self);                           \
	static void vec_##NAME##_clear(Vec_##NAME *self);                          \
